<%@ Page Title="" Language="C#" MasterPageFile="~/Index.master" AutoEventWireup="true" CodeFile="frm_StaffQualification.aspx.cs" Inherits="frm_Educational_Details" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    <center class="lineborder linebg">
        <h1 style="font-size:2.8em;text-align:center">Staff Academics Details</h1>
                        <asp:Image ID="img_educationDetails" runat="server" AlternateText="Image Not Found" ImageUrl="~/Images/112-book-morph-outline.gif" Height="200"></asp:Image></center>
                    

                <br /><h2>10th Details</h2>
    ...
    <asp:RequiredFieldValidator ID="rfv2_boardname" runat="server" ErrorMessage="BoardName is Required" ControlToValidate="txt10_boardname" Display="Dynamic" Font-Size="15px" ForeColor="Red" ValidationGroup="Marksheet"></asp:RequiredFieldValidator><br />

                 <font id="lbl10_totalmarksobt" runat="server">Enter TotalMarks Obtained : </font>
    <asp:TextBox ID="txt10_totalmarksobt" runat="server" Font-Size="12" valign="center" CssClass="lineborder linebg" OnTextChanged="txt10_totalmarksobt_TextChanged" AutoPostBack="true" MaxLength="4"></asp:TextBox>
    ...
    <asp:RangeValidator ID="RangeValidator3" runat="server" ErrorMessage="Enter Valid Marks" Type="Integer" MaximumValue="1000" MinimumValue="0" ControlToValidate="txt10_totalmarksobt" Display="Dynamic" Font-Size="15px" ForeColor="Red"></asp:RangeValidator><br />

                 <font id="lbl10_totalmarks" runat="server">Enter TotalMarks : </font>
    <asp:TextBox ID="txt10_totalmarks" runat="server" CssClass="lineborder linebg" OnTextChanged="txt10_totalmarksobt_TextChanged" AutoPostBack="True" MaxLength="4"></asp:TextBox> 
    ...
    <asp:RangeValidator ID="RangeValidator4" runat="server" ErrorMessage="Enter Valid Marks" Type="Integer" MaximumValue="1000" MinimumValue="0" ControlToValidate="txt10_totalmarks" Display="Dynamic" Font-Size="15px" ForeColor="Red"></asp:RangeValidator><br />
                <h2>12th Details</h2>
    ...
    <asp:RangeValidator ID="RangeValidator5" runat="server" ErrorMessage="Entered Number Must Between 1900 to 2022" Type="Integer" MaximumValue="2022" MinimumValue="1900" ControlToValidate="txt12_passingyear" Display="Dynamic" Font-Size="15px" ForeColor="Red"></asp:RangeValidator><br />
    ...
    <asp:RangeValidator ID="RangeValidator6" runat="server" ErrorMessage="Enter Valid Marks" Type="Integer" MaximumValue="1000" MinimumValue="0" ControlToValidate="txt12_totalmarksobt" Display="Dynamic" Font-Size="15px" ForeColor="Red"></asp:RangeValidator><br />
    ...
    <asp:RangeValidator ID="RangeValidator7" runat="server" ErrorMessage="Enter Valid Marks" Type="Integer" MaximumValue="1000" MinimumValue="0" ControlToValidate="txt12_totalmarks" Display="Dynamic" Font-Size="15px" ForeColor="Red"></asp:RangeValidator><br />
             ...
             <asp:GridView ID="dtGrd_Test" runat="server" Width="100%" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Total Marks">
                                <ItemTemplate>
                                    <input type="text" id="txtTotalMarks" runat="server" value='<%# Eval("TotalMarks") %>' style="margin:0px; width:85%; padding:5px;" />
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Top" Width="20%" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Obt Marks">
                                <ItemTemplate>
                                    <input type="text" id="txtObtMarks" runat="server" value='<%# Eval("ObtMarks") %>' style="margin:0px; width:85%; padding:5px;" />
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Top" Width="20%" />
                            </asp:TemplateField>
                        </Columns>
