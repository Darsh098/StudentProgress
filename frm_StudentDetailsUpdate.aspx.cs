...
public partial class frm_StudentDetailsUpdate : System.Web.UI.Page
{
    string QRY;
    ...
    {
        QRY = "SELECT * FROM Tbl_StudentEducationalDetails WHERE Stud_Id=" + StudId;
    ...
    {
        QRY = "SELECT * FROM Tbl_StudentPersonalDetails WHERE Stud_Id=" + StudId;
        ...
        while (DR.Read())
        {
            lblname.Text = DR["Stud_Name"].ToString();
            lblgender.Text = DR["Stud_Gender"].ToString();
            lblemail.Text = DR["Stud_Email"].ToString();
            lblbdate.Text = ((DateTime)DR["Stud_Bdate"]).ToString("yyyy-MM-dd");
            lblcontno.Text = DR["Stud_ContNo"].ToString();
        }
        DR.Dispose();
        CMD.Dispose();
        CNN.Close();
    ...
    protected void btn_edit_Click(object sender, EventArgs e)
    {
        ...
        {
            QRY = "UPDATE Tbl_StudentPersonalDetails SET Stud_Name='"+txtname.Text+"', ";
            QRY += "Stud_Gender='"+txtgender.Text+"', ";
            QRY += "Stud_Bdate='"+txtbdate.Value +"', ";
            QRY += "Stud_ContNo="+txtcontno.Text+" ";
            QRY += "WHERE Stud_Id="+StudId;
            CNN = new SqlConnection(CNS);
            CMD = new SqlCommand(QRY, CNN);
            CNN.Open();
            CMD.ExecuteNonQuery();
